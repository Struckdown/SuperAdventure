...
namespace Engine
{
    public class Location
    {
        ...
        public int MinimumLevelRequiredToEnter{ get; set; }
        ...
        public string NorthTravelText { get; set; } = null;
        public string EastTravelText { get; set; } = null;
        public string SouthTravelText { get; set; } = null;
        public string WestTravelText { get; set; } = null;
        ...
        public Location(int id, string name, string description,
            Item itemRequiredToEnter = null, int minimumLevelRequiredToEnter = 1, Quest questAvailableHere = null)
        {
            ID = id;
            Name = name;
            Description = description;
            ItemRequiredToEnter = itemRequiredToEnter;
            MinimumLevelRequiredToEnter = minimumLevelRequiredToEnter;
