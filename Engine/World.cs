...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Weapon(ITEM_ID_COPPER_SWORD, "Copper sword", "Copper sword", 0, 7, 8));
            ...
            Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5, 10));
